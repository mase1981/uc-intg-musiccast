...
- **Yamaha**: MusicCast multi-room audio platform
- **Unfolded Circle**: Remote 2/3 integration framework (ucapi)
- **aiomusiccast**: Python library by Vidar Tyldum
...
- **Yamaha Support**: [Official Yamaha MusicCast Support](https://usa.yamaha.com/products/audio_visual/hifi_components/musiccast/)

---

**Made with ❤️ for the Unfolded Circle and Yamaha MusicCast Communities**
